...
export default function CardEmpty(props){
    ...
    return (
    <div className={`card-game ${props.show && "turn"} ${props.show && props.selected && "selected"}`} title={titleCompleted} onClick={() => props.show && props.chooseMov()}>
        {props.amount > 1 && (
        ...
        <div className={`frontface ${props.show && props.selected && "selected"}`} type={`${props.type}`}>
            <div>
